...
// --- Colores del tema base (originales) ---
...
// --- Por Defecto: azul claro, blanco puro, negro ---
val DefaultButtonColor  = Color(0xFFBBDEFB)  // azul claro
...
val MagoTextColor       = Color(0xFFFFFFFF)  // blanco puro

// --- Vampiro: rojo, negro, blanco puro ---
val VampiroButtonColor  = Color(0xFFD32F2F)  // rojo
val VampiroBackground   = Color(0xFF0A0A0A)  // negro
val VampiroTextColor    = Color(0xFFFFFFFF)  // blanco puro

// --- Bosque: verde claro, verde oscuro, blanco ---
